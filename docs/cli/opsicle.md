...
* [opsicle login](cli/opsicle_login.md)	 - Login to Opsicle (alias of `opsicle create session`)
* [opsicle logout](cli/opsicle_logout.md)	 - Logs out of Opsicle from your terminal
* [opsicle register](cli/opsicle_register.md)	 - Accept invitations to collaborate on automation templates (alias of `opsicle create user`)
