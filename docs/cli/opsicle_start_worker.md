...
Starts the worker component that subscribes to the coordinator and polls for jobs to start
...
```
  -u, --coordinator-url string   the url of the coordinator service (default "http://localhost:13372")
