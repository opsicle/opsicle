...
* [opsicle start coordinator](cli/opsicle_start_coordinator.md)	 - Starts the coordinator component
* [opsicle start reporter](cli/opsicle_start_reporter.md)	 - Starts the reporter component
